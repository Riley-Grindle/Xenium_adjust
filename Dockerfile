...
ENTRYPOINT /usr/local/bin/xeniumranger-xenium3.1/bin/xeniumranger import-segmentation --id=baysor --xenium-bundle=$xenium --transcript-assignment=$segmentation --viz-polygons=$polygons --units=microns --localcores=32 --localmem=128 
